...
namespace MT.Online.Restaurant.MessagesManagement.Services
{
    ...
    {
        const string ServiceBusConnectionString = "sb://microservice301.servicebus.windows.net/;SharedAccessKeyName=send-sb-key;SharedAccessKey=/aOwIMYAnf4XfxwbtAsvs7sVtYNAyHVf6g+1CT54KE4=;EntityPath=topic-microservice";
